/**
 * data.js
 * Shared content for the Pawsonality quiz.
 * - QUIZ_QUESTIONS: the 15 questions, each option tagged with the archetype it scores.
 * - ARCHETYPES: the 6 possible results, incl. curated real facts (own-content requirement)
 *   and the query used to look the animal up in the live API.
 *
 * No classes here on purpose — this is plain data, consumed by the Quiz / ResultsPage classes.
 */
...
// Exposed for quiz.js / results.js / api.js (plain <script> includes, no bundler)
